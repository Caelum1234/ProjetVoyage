...
$reservationRequete = $connexion->query('SELECT * FROM reservaion');
      ...
      <div class="row">
        <div class="col-sm-4 offset-md-1 py-4">
          <ul class="list-unstyled">
            ...
            <li><a href="edit/editCircuit.php" class="text-white">Circuit : <?php echo $etape ?></a></li>
            <li><a href="edit/editCircuit.php" class="text-white">Circuit : <?php echo $lieuxVisiste ?></a></li>
            <li><a href="edit/editUser.php" class="text-white">Utilisateur : <?php echo $utilisateur ?></a></li>
            <li><a href="edit/editCircuit.php" class="text-white">Circuit : <?php echo $reservation ?></a></li>
